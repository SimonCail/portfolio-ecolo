                    ...
                    <article key={exp.id} className="relative group">
                        ...
                        <div className="group/main cursor-default">
                            <div className="flex flex-col sm:flex-row sm:items-baseline justify-between mb-1">
                                <h3 className="text-lg font-bold text-cv-paper group-hover/main:text-cv-accent transition-colors">
                                    {exp.role}
                                </h3>
                        ...
                        {exp.subProjects && (
                            <div className="space-y-4 mt-2">
                                <p className="text-cv-muted text-sm mb-3 group-hover/main:text-cv-ink transition-colors">
                                    {exp.description}
                                </p>
