                        ...
                        {exp.subProjects ? (
                            <div className="space-y-4 mt-2">
                                ...
                                {exp.subProjects.map((sub: any, index: number) => (
                                    <div key={index} className="relative pl-4 border-l-2 border-eco-border hover:border-cv-accent/50 transition-colors">
                                        <h4 className="text-sm font-bold text-cv-ink mb-1">{sub.title}</h4>
